    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-primary text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="bg-primary group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("text-primary hover:text-primary hover:bg-card", className, isMobile ? "" : "min-[1025px]:hidden")}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
